...
export class StudentService {
  ...
  addStudentDetail(
    ...
    this.http
      .post<{ message: string; studentId: string }>(
        "https://immense-peak-24786.herokuapp.com:3000/api/student",
        studentData
      )
      .subscribe((res) => {
        console.log(res);
  ...
  deleteStudentRecord(id: string) {
    this.http
      .delete("https://immense-peak-24786.herokuapp.com:3000/api/student/" + id)
      .subscribe(() => {
  ...
  updateStudentRecord(
    ...
    console.log("matched");
    this.http
      .put("https://immense-peak-24786.herokuapp.com:3000/api/student/" + id, studentData)
      .subscribe((res) => {
        console.log(res);
      });
  }
